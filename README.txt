...
Ex1 : 
Contorls: wasd for movement on the map/matrix
	I for inventory
	ID for inventory with indexes

The game ends when all the memes are caught
The battle takes place with a random chance to attack or to dodge the attack 
You use X for attack and using items
You use Z for dodging the attacks
