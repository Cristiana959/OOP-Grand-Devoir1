                ...
                case "t":
                    ...
                    transform = sc.next();
                        ...
                        case "c":
                            ...
                            while (!(collect.equals("x"))) {
                                if(((collect.equals("c"))) || ((collect.equals("w"))) || ((collect.equals("i"))) || ((collect.equals("s"))) || ((collect.equals("m"))) || ((collect.equals("x")))){
                                if(collectLimit > 0){
                                switch (collect) {
                                    case "c":
