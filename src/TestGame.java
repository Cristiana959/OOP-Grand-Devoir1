...
public class TestGame {
    ...
    public static void initAll() {
        ...
        Personnage main_character_girl = new Personnage("Hawkeye Iulia", 100, 150);
        Personnage dummy = new Personnage("Dummy", 1, 1);
        Personnage oger = new Personnage("Ogre Marian Baiat Gigel", 10, 10);
        Personnage archer = new Personnage("Shooting Range Carmina", 25, 25);
